...
import com.miyuyan.sysuer.databinding.PreferenceRangeSliderBinding
...
class RangeSliderPreference(context: Context,
	...
	constructor(context: Context, attrs: AttributeSet? = null) : this(context, attrs, R.attr.rangeSliderPreferenceStyle)
