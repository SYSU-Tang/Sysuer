        ...
        noticeContent?.let { content ->
            ...
            val options = sharedElementBounds?.let { bounds ->
                activity?.let { act ->
                    ...
                    val opt = ActivityOptionsCompat.makeSceneTransitionAnimation(act, view, "miniapp")
                        .toBundle()
                ...
                ActivityOptionsCompat.makeSceneTransitionAnimation(it, it.window.decorView, "miniapp")
                    .toBundle()
            }
