...
@Parcelize data class CourseFilterValueData(var courseName: String? = "",
                                            ...
                                            var specialClassCode: String? = "") : Parcelable {
...
@Parcelize data class CourseFilterNameData(var courseName: String? = "",
                                           var studyCampusId: String? = "",
                                           var week: String? = "",
                                           var classTimes: String? = "",
                                           var courseUnitNum: String? = "",
