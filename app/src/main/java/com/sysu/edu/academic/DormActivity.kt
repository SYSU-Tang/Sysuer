...
public class DormActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        model.getMessage().observe(this, message -> {
            ...
            if (data != null && data.containsKey("code") && data.getInteger("code") == 200) {
                data = data.getJSONObject("data");
                StaggeredFragment list = new StaggeredFragment();
                tabs.add(getString(R.string.personal_info));
                pager2Adapter.add(list);
                list.add(getString(R.string.personal_info), CommonUtil.getString(this, List.of(R.string.name, R.string.student_id, R.string.gender, R.string.school, R.string.major, R.string.grade, R.string.training_level, R.string.stay_school_status, R.string.student_status, R.string.contact_number)),
                ...
                data.getJSONArray("stayRecordList").forEach(e -> list1.add(((JSONObject) e).getString("schoolYear"), CommonUtil.getString(this, List.of(R.string.year, R.string.campus, R.string.building, R.string.floor, R.string.room_number, R.string.bed_number, R.string.accommodation_fee, R.string.stay_start_date, R.string.stay_end_date)),
                ...
                data.getJSONArray("stayChargeRecordList").forEach(e -> list2.add(((JSONObject) e).getString("schoolYear"), CommonUtil.getString(this, List.of(R.string.year, R.string.accommodation_standard, R.string.should_pay_stay_charge, R.string.real_pay_stay_charge, R.string.arrears)),
