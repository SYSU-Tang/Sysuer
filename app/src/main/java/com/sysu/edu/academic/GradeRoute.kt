            ...
            Row(
                ...
                Column {
                    ...
                    DropdownMenu(expanded = yearExpanded, onDismissRequest = { yearExpanded = false }) {
                        DropdownMenuItem(
                            ...
                            onClick = {
                                viewModel.yearName = context.getString(R.string.all)
                ...
                Column {
                    OutlinedButton(onClick = { termExpanded = true }) {
                        Text(viewModel.terms.getOrNull(viewModel.termIndex) ?: stringResource(R.string.term))
                    }
...
fun ScoreItem(
    ...
    val markdown = """
        ...
        - 成绩：**${
            if (score.getString("originalScore") == null) context.getString(R.string.click_for_grade)
