...
class SchoolEnrollmentActivity : BaseActivity() {
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		enableEdgeToEdge()
		val viewModel = ViewModelProvider(this)[SchoolEnrollmentViewModel::class.java]
		val basicNames = mapOf(R.string.school_enrollment_personal_info to intArrayOf(R.string.school_enrollment_student_number,
		                       ...
		                       R.string.school_enrollment_roll_info to intArrayOf(R.string.school_enrollment_college,
		                       ...
		                       R.string.school_enrollment_contact_info to intArrayOf(R.string.school_enrollment_phone,
		...
		val basicKeys: Map<Int, Array<String?>> = mapOf(R.string.school_enrollment_personal_info to arrayOf("studentNumber",
		                                                                                                    "basicName",
		                                                                                                    "basicEngName",
		                                                                                                    "basicNameSpell",
		                                                                                                    "basicChName",
		                                                                                                    ...
		                                                                                                    "basicExaNumber"),
		                                                R.string.school_enrollment_roll_info to arrayOf("rollCollegeNumNAME",
		                                                                                                "rollDepartmentNAME",
		                                                                                                "rollGrade",
		                                                                                                ...
		                                                                                                "originGradAuthen",
		                                                                                                "originStuTrait"),
		                                                R.string.school_enrollment_contact_info to arrayOf("contaPhone", "contaLetter", "contaArrive", "contaWeChat", "contaPostalCode", "contaFaPhone", "contaEailAddress", "contaFaAddress"))
		val tabNames = arrayOf(intArrayOf(R.string.school_enrollment_relation,
		                                  R.string.school_enrollment_family_name,
		                                  R.string.school_enrollment_work_unit,
		                                  R.string.school_enrollment_position,
		                                  R.string.school_enrollment_family_phone,
		                                  R.string.school_enrollment_family_birthday),
		                       intArrayOf(R.string.school_enrollment_study_start, R.string.school_enrollment_study_end, R.string.school_enrollment_study_unit, R.string.school_enrollment_study_address),
		                       intArrayOf(R.string.school_enrollment_exchange_start, R.string.school_enrollment_exchange_end, R.string.school_enrollment_sent_school, R.string.school_enrollment_sent_major, R.string.school_enrollment_exchange_status),
		                       intArrayOf(R.string.school_enrollment_issue_date,
		                                  R.string.school_enrollment_issue_number,
		                                  R.string.school_enrollment_move_type,
		                                  R.string.school_enrollment_change_detail,
		                                  R.string.school_enrollment_move_reason,
		                                  R.string.school_enrollment_former_major,
		                                  R.string.school_enrollment_after_major),
		                       intArrayOf(R.string.school_enrollment_minor_type, R.string.school_enrollment_minor_college, R.string.school_enrollment_minor_major, R.string.school_enrollment_minor_grade, R.string.school_enrollment_minor_graduation),
		                       intArrayOf(R.string.school_enrollment_academic_year, R.string.school_enrollment_checkin_status, R.string.school_enrollment_register_status, R.string.school_enrollment_payment_status),
		                       intArrayOf(R.string.school_enrollment_punish_date,
		                                  R.string.school_enrollment_punish_brief,
		                                  R.string.school_enrollment_punish_type,
		                                  R.string.school_enrollment_punish_source,
		                                  R.string.school_enrollment_punish_name,
		                                  R.string.school_enrollment_punish_reason,
		                                  R.string.school_enrollment_punish_time,
		                                  R.string.school_enrollment_punish_proof,
		                                  R.string.school_enrollment_punish_repeal_time,
		                                  R.string.school_enrollment_punish_repeal_proof,
		                                  R.string.school_enrollment_punish_graduate,
		                                  R.string.school_enrollment_punish_degree,
		                                  R.string.school_enrollment_punish_sponsor,
		                                  R.string.school_enrollment_punish_department,
		                                  R.string.school_enrollment_punish_clause,
		                                  R.string.school_enrollment_punish_money,
		                                  R.string.school_enrollment_punish_status,
		                                  R.string.school_enrollment_punish_in_school))
		val tabKeys: Array<Array<String?>> = arrayOf(arrayOf("familyRelationName", "familyMemberName", "familyWorkUnit", "jobName", "familyPhone", "familyBirthday"),
		                                             arrayOf("experBeginTime", "experEndTime", "experStudyUnit", "experSite"),
		                                             arrayOf("startTime", "endTime", "sendToCollegeName", "sentToMajorName", "exchangeStatus"),
		                                             arrayOf("issueDate", "issueNumber", "moveStyle", "changeDetail", "moveReason", "formerGradeMajorProf", "moveAfterGradeMajorProf"),
		                                             arrayOf("mrollCultureGenreName", "mrollCollegeName", "mrollMajorFieldName", "mrollGrade", "minDouDegMajGradName"),
		                                             arrayOf("academicYearTerm", "checkInStatusName", "registerStatusName", "payedStatusName"),
		                                             arrayOf("rewPundate",
		                                                     "rewPunBriefing",
		                                                     "rewPunTypeName",
		                                                     "rewPunSourceName",
		...
		setContent {
			...
			val allSections = Array(8) {
				mutableStateListOf<SectionData>()
			}
			basicInfo?.let { data ->
				basicNames.forEach { (titleRes, names) ->
					val keys = basicKeys[titleRes] ?: emptyArray()
					allSections[0].add(SectionData(title = getString(titleRes), rows = extractValue(this@SchoolEnrollmentActivity, data, names, keys)))
				}
			}
			(0..6).forEach {
				listOf(familyList, experienceList, exchangeList, changeList, minorList, registerList, punishList)[it].forEachIndexed { index, item ->
